...
def test_encrypt():
    ...
    """
    assert RailFence.encrypt("WE ARE DISCOVERED FLEE AT ONCE", 3) == "WRIVDETCEAEDSOEE LEA NE  CRF O"
...
def test_decrypt():
    assert RailFence.decrypt("WRIVDETCEAEDSOEE LEA NE  CRF O",3) == "WE ARE DISCOVERED FLEE AT ONCE"
